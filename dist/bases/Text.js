...
exports.Text = exports.TextProps = void 0;
...
var TextProps = /** @class */ (function (_super) {
    ...
    ], TextProps.prototype, "contrastingColor", void 0);
    return TextProps;
}(createRSC_1.RSCProps));
exports.TextProps = TextProps;
var Text = function (p) {
    return react_1.default.createElement('span', TextProps.of(p));
};
exports.Text = Text;
exports.Text.of = createOf_1.createOf(exports.Text);
