...
export declare const ResponsiveFlex: {
...
export declare const ResponsiveImage: {
    (p: import("..").RSProps<import("../bases/Image").ImageProps, import("react").ReactNode>): JSX.Element;
    of: (base: import("..").RSProps<import("../bases/Image").ImageProps, import("react").ReactNode>) => {
        (p: import("..").RSProps<import("../bases/Image").ImageProps, import("react").ReactNode>): JSX.Element;
        displayName: string;
        of: any;
    };
};
export declare const ResponsiveBackground: {
...
export declare const ResponsiveContent: {
    (p: import("..").RSProps<import("../bases/Container").ContainerProps, import("react").ReactNode>): JSX.Element;
    displayName: string;
    of: (base: import("..").RSProps<import("../bases/Container").ContainerProps, import("react").ReactNode>) => any;
};
