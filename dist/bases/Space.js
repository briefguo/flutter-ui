...
function SingleSpace(p) {
    ...
    var _a = p.direction, direction = _a === void 0 ? 'horizen' : _a, _b = p.box, box = _b === void 0 ? 'inline-flex' : _b, align = p.align, gutter = p.gutter, props = __rest(p, ["direction", "box", "align", "gutter"]);
    switch (direction) {
        case 'vertical':
...
exports.Space = exports.ResponsiveSpace;
